...
| `ms-02` | Phase B: The Connection | 2026-01-10 | Implement Google Calendar integration via KDE Online Accounts. | Display a list of event titles from the configured Google account. |
...
| `task-301` | `ms-03` | Connect Weather DataEngine | Jules | 3 | `in_review` | `org.kde.weather` or Plasma 6 provider. |
